...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/paldenongmolhendup/Desktop/Exam scheduling app/project'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/paldenongmolhendup/Desktop/Exam scheduling app/project/bin/deactivate.nu'
